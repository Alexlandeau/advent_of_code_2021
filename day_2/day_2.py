...
print(f"Part 1: final position is horizon: {position.get('horizontal')}, depth: {position.get('depth')}, coordinates product is {position.get('horizontal') * position.get('depth')}")
...
position = starting_position.copy()
[read_instruction(position, instruction) for instruction in instructions]
print(f"Part 2: final position is horizon: {position.get('horizontal')}, depth: {position.get('depth')}, coordinates product is {position.get('horizontal') * position.get('depth')}")
